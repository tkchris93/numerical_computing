...
The second updates all packages so that they match with the current release version of Anaconda. Because Anaconda has this capability, it is a good idea to install pacakges using \li{conda} whenever possible.
