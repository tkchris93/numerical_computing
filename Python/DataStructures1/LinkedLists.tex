...
This is an excellent object to use in practice instead of a Python \li{list} when speed is of the essence.

\begin{problem}
(Optional) Write \li{Stack}, \li{Queue}, and \li{Deque} classes.

The \li{Deque} class should inherit from the \li{DoublyLinkeList} class.
Use inheritance to implement \li{append}, \li{appendleft}, \li{pop}, and \li{popleft} methods as described in the preceding section.
