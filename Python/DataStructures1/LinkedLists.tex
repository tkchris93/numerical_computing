...
Write a function called \li{sort_words} that sorts the list generated by \li{create_word_list("English.txt")} by adding them to a \li{SortedLinkedList} object.
Then return the object.

(Warning: \li{English.txt} contains over 58,000 English words.
