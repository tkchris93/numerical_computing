...
\objective{Identify which portions of the code require the most time using a profiler. Optimize Python code using Cython and Numba and other tools.}
...
We will discuss Cython and Numba in the next section.
...
\subsection*{Compilation in IPython}
...
In [2]: %%cython
   ...
   ...:
\end{lstlisting}
In the optional section at the end of this lab, we discuss how to compile Cython code from the command line.

Now the \li{qr()} function has been compiled in Cython and can be called from IPython just as any other function. 
...
\begin{lstlisting}
TODO: Make sure this matches lab standards
