...
def resulting_list():
	my_list = []   # replace [] with the list resulting from the perscribed operations.
	return my_list 
...
# PROBLEM 7: Translate numbers 1-26 to their corresponding letters of 
#            the alphabet using dictionaries
