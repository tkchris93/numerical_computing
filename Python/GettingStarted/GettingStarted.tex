...
\begin{problem}
Write a function \li{volume_sphere} that accepts a parameter \li{r} and returns the volume of a sphere of radius \li{r}.
\end{problem}
...
\begin{problem}
Write a function \li{odds} that accepts a parameter \li{n} and returns the first \li{n} odd numbers.  This function can be implemented using one line of code.
\end{problem}
