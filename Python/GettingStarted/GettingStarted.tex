...
\begin{problem}
Write a function \li{odds} that accepts a parameter \li{n} and returns a list of the first \li{n} odd numbers.  This function can be implemented using one line of code.
\end{problem}
