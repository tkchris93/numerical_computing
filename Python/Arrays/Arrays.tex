...
Similarly, slicing an array works just like slicing a list, but with more dimensions.  When dealing with multi-dimensional arrays, a single \li{:} as an argument extracts everything in the specified axis.
\begin{lstlisting}
