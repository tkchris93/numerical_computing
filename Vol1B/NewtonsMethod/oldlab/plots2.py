...
def fractal_ex():
    ...
    ymin=-1.5
    ymax=1.5
    plot_basins(f,Df,roots1,xmin,xmax,ymin,ymax, numpoints=700, name='figures/fractal_ex.png')
...
def fractal_hw():
    ...
    plot_basins(g,Dg,roots2,xmin,xmax,ymin,ymax, numpoints=700, name='figures/fractal_hw.png')
...
def fractal_zoom():
    ...
    ymin=-.015
    ymax=.015
    plot_basins(f,Df,roots1,xmin,xmax,ymin,ymax, numpoints=700, name='figures/fractal_zoom.png')
