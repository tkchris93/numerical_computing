...
BeautifulSoup is a Python package that helps with navigating HTML documents.
...
\begin{problem}
In the Three Stooges example, what code would you use to return the following?
\begin{lstlisting}
[u'title']
\end{lstlisting}
\end{problem}
...
<<u'Mo'>>
\end{lstlisting}
2. Download 'example.htm' associated with the lab into your working directory.
...
In actual website HTML, often there are too many tags that share a common name.
