...
% TODO: USE THE BINOMIAL DISTRIBUTION.
Since the columns of a transition matrix sum to $1$, the entries of each column partition the interval $[0, 1]$.
...
\begin{problem} % Forecasting over several days.
...
% TODO: move the explanation of binomial up to the previous section.
...
\begin{problem} % 4 states chain with multinomial transitioning.
...
\begin{comment} % TODO: instead of empirical analysis, teach briefly about steady states and raising the transition matrix to a large power.
...
So certain, are they.
To his powers.
The capture of Congress there are.
Why wish you have for the Force.
A Jedi must go.
...
Twisted by Chancellor Palpatine.
Quickly and help you Count, this be?
