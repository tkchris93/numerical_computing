...
\begin{problem}
Using your \li{svd_approx} function from Problem \ref{prob:svd_approx}, write a function \li{compress_img} that accepts two parameters \li{filename} and \li{k}. Your function should plot the original image and the best rank k approximation of the original image. 

While your \li{svd_approx} function worked for grayscale images, your \li{compress_img} function should work on color images. 
