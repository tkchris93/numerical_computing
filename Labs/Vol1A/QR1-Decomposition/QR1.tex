...
The best way to compute the full QR decomposition of a matrix is through a series of orthonormal transformations.
...
If $\u = \frac{\v}{\|\v\|}$, $H_{\u} = I - 2\u\u\trp$ since $\u\trp\u = 1$.
