...
\begin{comment}
The final problem is to find an efficient algorithm for actually computing $Q$ and $R$.
The idea is to start with $R=A$ and $Q = I$.
Then we compute $Q_1$ and modify $R$ to be $Q_1A$ and $Q$ to be $Q_1$.
