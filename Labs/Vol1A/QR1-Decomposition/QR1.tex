...
The matrix representation of the Householder transformation that reflects about $\v^\perp$ is given by $H_{\v} = I - 2\frac{\v\v\trp}{\v\trp\v}$.
...
The Householder transformation $H_{\mathbf{v}}$ of $\mathbf{x}$ is the reflection of $\mathbf{x}$ across $\v^\perp$.}
