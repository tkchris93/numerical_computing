...
\begin{enumerate}
\item Implement the method \li{FacialRec.initMeanImage()}.
Compute the mean face as described above and store it as \li{self.mu}.
...
\leavevmode
\begin{enumerate}
\item Implement the method \li{FacialRec.initDifferences()}.
