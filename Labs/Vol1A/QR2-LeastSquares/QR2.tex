...
The data in \texttt{housing.npy} is nonlinear, and might be better fit by a polynomial.

Write a function that uses Equation \ref{eq:polynomial-least-squares} to calculate the polynomials of degree $3$, $6$, $9$, and $32$ that best fit the data.
...
However, such a polynomial is subject to numerical errors and conditioning problems.
