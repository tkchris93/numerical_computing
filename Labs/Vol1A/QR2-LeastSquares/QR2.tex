...
Test your function on small random matrices, using \li{scipy.linalg.eig()} to compare your solutions to the actual eigenvalues.
...
We will return to this subject after studying spectral calculus.
\end{info}
