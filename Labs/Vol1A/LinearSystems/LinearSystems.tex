...
NumPy's matrix algorithms that employ row reduction use several clever tricks to minimize the impact of round-off errors, but even these tricks can't fix ill-conditioned matrices.
\end{warn}
...
\subsection*{Robust REF Reducers}
