...
The difference in spatial complexity occurs because a full array occupies a block of memory for each entry, so a $n \times n$ array requires $n^2$ blocks of memory. 
