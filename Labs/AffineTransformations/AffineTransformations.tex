...
Included with this lab is a dataset of points saved as a numpy array. To import this array, use \li{np.load("pi.npy")}. This function will return an array of size $(2, 368)$. This array represents $368$ points in $\mathbb{R}^2$ stored as columns.

To check your work, plot the original points and their images under the transformation using the function \li{plot_transform()} defined below.
\begin{lstlisting}
import numpy as np
...
\begin{problem}
 ...
 To check your work, plot the original points and their images under the transformation using the function \li{plot_transform()} defined in Problem \ref{prob:dilation}.
\end{problem}
...
Hint: To check your work, plot the original points and their images under the transformation using the function \li{plot_transform()} defined in Problem \ref{prob:dilation}.
\end{problem}
\end{comment}
...
Hint: You can construct a $2 \times 1$ array using the syntax \li{np.vstack([a,b])}.
This may be more convenient for broadcasting. 
Another hint: To check your work, plot the original points and their images under the transformation using the function \li{plot_transform()} defined in Problem \ref{prob:dilation}.
\end{problem}
...
\end{itemize}
\end{enumerate}
\item Plot the trajectory of $p_1$ on the time interval $(0, 10)$ assuming $\omega=\pi$, $v=(1, 1)$, and $s=2$. 
...
Print each of these times. What can you conclude about the more efficient way to solve linear systems?
\end{enumerate}
\end{problem}
