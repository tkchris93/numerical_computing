...
\leavevmode
\begin{enumerate}
\item Finish writing the function \li{filter} by filling in lines 5, 6, and 10.  Hint: Note in \ref{equ:convolve}, $C_ij$ was calculated by summing from -1 to 1.  This is only the case if the filter \li{F} is $3 \times 3$. A slight modification is needed in the general case.
