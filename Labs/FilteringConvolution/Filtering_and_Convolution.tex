...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{new_noisyspec}
...
\item Read in \li{chopin.wav} and the impulse response with \li{wavfile}, 
\item Add several seconds of silence to the signal from \li{chopin.wav},
