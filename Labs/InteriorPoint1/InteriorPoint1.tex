...
This is the primal problem, and its dual takes the form:
\begin{align*}
...
% MARK THIS AS IMPORTANT or put it somewhere else.
...
The constraints on the problem make this process a little more complicated than the unconstrained line search we have studied previously.
