...
The function should take in the set of data points (as a list of tuples) and a single target point.
Return distance to the closest data point and the index of that point.
