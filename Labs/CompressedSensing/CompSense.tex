...
% \end{lstlisting}
% Where \li{faces}, \li{verticies} and \li{colors} are given by the tesselation. To take a picture, use the function
% \begin{lstlisting}
...
The file \texttt{StudentEarthData.npz} contains the faces, vertices, and colors, %and the inverse fourier matrix,
accessed by the keys \li{'faces'}, \li{'vertices'}, and \li{'C'}, % and \li{'V'},
respectively.
