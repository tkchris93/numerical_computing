...
In the file \li{StudentRubiksData.npz}, we have given you the measurement matrices for each color channel (accessed by the keys \li{'A1', 'A2', 'A3'}) along with the respective measurements in each color channel (accessed by the keys \li{'b1', 'b2', 'b3'}).
