...
\begin{problem}
Write a function called \li{clean-image()} which accepts the name of a grayscale image file, and cleans high-frequency noise out of the image.
...
Next, the discrete wavelet transform is used to calculate the wavelet coefficients, and these are then \textit{quantized},
