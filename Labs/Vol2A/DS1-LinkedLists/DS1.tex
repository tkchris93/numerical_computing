...
Read the first file, adding each line to a deque (use a Python \li{list}, your \li{Deque} class, or \li{collections.deque}. Which one is fastest?).
After reading the entire file, pop each entry off the stack one at a time and write it to the second file.
...
The \li{LinkedList} class is still somewhat plain.
...
How efficient is this data structure in the worst case scenario?
