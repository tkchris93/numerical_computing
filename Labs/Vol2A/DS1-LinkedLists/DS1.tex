...
% TODO: Move this to "Additional Material" section.
...
\begin{problem} % SortedList class.
...
\begin{enumerate}
\item Use inheritance to implement the \li{appendleft()}, \li{pop()}, and \li{popleft()} methods as described in the preceding section (the \li{LinkedList} class already implements\li{append()}).
...
% TODO: Split this into a separate problem.
...
% Queue
% SortedList
% CircularList (tikzpicture probably needed)
