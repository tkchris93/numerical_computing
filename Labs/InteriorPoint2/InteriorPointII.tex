...
\[
\hat{\nu} = \frac{1}{m}(y + \hat{\alpha}\triangle y)^T(\lambda + \hat{\alpha}\triangle \lambda),
\]
...
\begin{comment} % TODO: fix this algorithm and put it back in -----------------
...
\end{info}
\end{comment} % TODO: fix this algorithm and put it back in -------------------
...
% You will need to call this function at the start of your algorithm.
