...
\begin{lstlisting}
def specClus(measure,Laplacian,args,arg1=None):
    """
    Cluster a dataset using the k-means algorithm.
...
def test_specClus(radii,pts,Laplacian,arg1):
    ...
    spec_clus_labels = specClust(measure,Laplacian,args,arg1)
