...
\begin{problem} % Problem 4: put it all together.
...
This tells the interpreter to look up one level, then to go into the \texttt{tools} directory and look for the \texttt{calculator.py} module.
