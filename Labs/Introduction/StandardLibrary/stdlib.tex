...
In Python files, all import statements should occur at the top, below the header but before any other code.
...
In IPython, note the difference in behavior between when the file is run and when it is imported.
