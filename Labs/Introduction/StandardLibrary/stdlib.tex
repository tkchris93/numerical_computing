...
\begin{lstlisting}
In [1]: run example1.py              # or just 'run example1'.
<<Data: [1, 2, 3, 4]
This file was executed from the terminal or an interpreter.>>
...
If a module has been imported in IPython and the source code then changes, using \li{import} again will \textbf{not} refresh the name in the IPython namespace.
Instead, use \li{run} to correctly refresh the namespace.
...
% TODO: keep but simplify this example.
