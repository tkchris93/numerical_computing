...
% Since $<$ is a boolean binary operator, \li{__lt__()} should return either \li{True} or \li{False}.
...
% TODO: Subsection and problem on HASHING. Be brief.

\begin{problem} % Problem 4: ComplexNumber class
