...
Python has some very useful built-in functions that can be used in conjunction with the \li{for} statement:
\begin{enumerate}
...
Translate the list of numbers into a single string, where each integer correspondings lower-case letter of the alphabet.
