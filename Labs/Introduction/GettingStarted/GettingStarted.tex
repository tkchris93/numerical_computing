...
\begin{problem} % Problem 1: Run a file that prints "Hello, world!"
...
\begin{problem} % Problem 2: write a very basic function.
...
\begin{problem} % Problem 3: Slicing with strings.
...
\begin{problem} % Problem 4: List operations.
...
\begin{problem} % Problem 5: If statements and Pig Latin.
...
\begin{problem} % Problem 6: int_to_string().
...
\begin{problem} % Problem 7: the alternating harmonic series.
