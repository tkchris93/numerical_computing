...
The plotting techniques presented here will be used in the majority of the labs in this curriculum.}

\section*{Line Plots} % =======================================================

The quickest way to visualize a simple 1-D array is via a \emph{line plot}.
In the following example, we create an array to visualize and plot it using the \li{matplotlib} module.\footnote{Like NumPy, Matplotlib is \emph{not} part of the Python standard library, but is included in most Python distributions.}
...
\includegraphics[width=.5\textwidth]{discontinuousProblem.pdf}
\end{figure}
\end{problem}
...
\begin{subfigure}{.15\textwidth}
    \centering
    \includegraphics[width=\linewidth]{layout_1.pdf}
\end{subfigure}
%
\begin{subfigure}{.15\textwidth}
    \centering
    \includegraphics[width=\linewidth]{layout_2.pdf}
\end{subfigure}
%
\begin{subfigure}{.15\textwidth}
    \centering
    \includegraphics[width=\linewidth]{layout_3.pdf}
\end{subfigure}
\\
\begin{subfigure}{.15\textwidth}
    \centering
    \includegraphics[width=\linewidth]{layout_4.pdf}
\end{subfigure}
%
\begin{subfigure}{.15\textwidth}
    \centering
    \includegraphics[width=\linewidth]{layout_5.pdf}
\end{subfigure}
%
\begin{subfigure}{.15\textwidth}
    \centering
    \includegraphics[width=\linewidth]{layout_6.pdf}
\end{subfigure}
...
\begin{subfigure}{.49\textwidth}
    \centering
    \includegraphics[width=\linewidth]{subplots_1.pdf}
\end{subfigure}
%
\begin{subfigure}{.49\textwidth}
    \centering
    \includegraphics[width=\linewidth]{subplots_2.pdf}
\end{subfigure}
\end{figure}
...
\begin{enumerate}
    ...
    2\sin(2x)\text{: blue dashed line.} && 2\sin(2x)\text{: magenta dotted line.}
    \end{array}\end{align*}
\end{enumerate}
\end{problem}
...
% BAR CHARTS SECTION HERE (maybe steal it from datavis)
...
With a 2-dimensional domain, we can now visualize $f$ with a few different kinds of plots.

A \emph{heat map} assigns a color to each entry in the matrix, producing a 2-D picture describing a 3-D shape.
...
# Plot a contour map with 10 level curves.
>>> plt.contour(X, Y, Z, 10)
>>> plt.show()

# Plot a filled contour map, specifying the level curves.
>>> plt.contourf(X, Y, Z, [-.99, -.5, 0, .5, .99])
>>> plt.show()
\end{lstlisting}
...
\begin{subfigure}{.33\textwidth}
    ...
    \caption{A contour map of $f$ with 10 level curves.}
    \label{fig:surface}
\end{subfigure}%
\begin{subfigure}{.33\textwidth}
    \centering
    \includegraphics[width=\linewidth]{sinxsiny_3d.pdf}
    \caption{A filled contour map with specified level curves.}
    \label{fig:surface}
\end{subfigure}
...
\begin{figure}[H]
\includegraphics[width=.7\textwidth]{colormeshProblem.png}
\end{figure}
\end{problem}

Three-dimensional data can also be displayed with a \emph{contour plot}, which draws level curves of a function (the lines in the plane where the function is constant)---like a topographical map.
Coloring the space between the contour lines with sufficiently fine level curves produces a heat map.

Use \li{plt.contour()} instead of \li{plt.plot()} to create a contour plot.
To create a filled contour map, use \li{plt.contourf()}.
