...
Run Problem \ref{prob:sphere} with multiple different values of \li{N}.
The smallest value of \li{N} used should be 50 and the largest value should be 50000. 
You should use at least 50 values of \li{N} in the interval ${[50,50000]}$.
...
\item Repeat this several times to get several estimates of the relative error. Your function should accept a keyword argument \li{numEstimates} that defaults to 50.
