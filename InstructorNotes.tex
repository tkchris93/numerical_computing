...
\begin{appendices}
\subimport{./Labs/Introduction/}{Notes}
\subimport{./Labs/Vol1A/}{Notes}
\subimport{./Labs/Vol1B/}{Notes}
\subimport{./Labs/Vol2A/}{Notes}
\subimport{./Labs/Vol2B/}{Notes}
\subimport{./Labs/Vol3A/}{Notes}
\subimport{./Labs/Vol3B/}{Notes}
\subimport{./Labs/Vol4A/}{Notes}
\subimport{./Labs/Vol4B/}{Notes}
\end{appendices}
